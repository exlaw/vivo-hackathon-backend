...
public class FormatDateTime {
    ...
    public static String toShortDateString(long timestamp) {
        SimpleDateFormat myFmt = new SimpleDateFormat("yy年MM月dd日HH时mm分");
        return myFmt.format(timestamp);
    }

    public static String toShortDateStringByMonth(long timestamp) {
        SimpleDateFormat myFmt = new SimpleDateFormat("yy年MM月");
        return myFmt.format(timestamp);
    }
    ...
    public static boolean isExceedTime(long timestamp) {
        Date dt = new Date();
